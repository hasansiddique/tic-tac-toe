...
import EmptyPieceSVG from '../../components/game-pieces/empty-svg/EmptyPieceSVG';
import XPieceSVG from '../../components/game-pieces/x-svg/XPieceSVG';
import OPieceSVG from '../../components/game-pieces/o-svg/OPieceSVG';
import GameSquare from '../../components/game-square/GameSquare';
...
export default function GameBoardSquares({
  board,
  height,
  width,
  playerMoveHandler,
